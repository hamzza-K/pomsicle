...
@app.function_name(name="KnowledgeBaseOptions")
@app.route(route="knowledgebase", methods=["OPTIONS"], auth_level=func.AuthLevel.ANONYMOUS)
def knowledgebase_options(req: func.HttpRequest) -> func.HttpResponse:
    cors_headers = {
